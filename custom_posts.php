...
function get_wp_emprendedores_custom_fields ($type) {
  if($type == 'emprendedor-pregunta') return get_emprendedores_preguntas_custom_fields();
}

function wp_emprendedores_show_custom_fields() { //Show box
  global $post;
  $type = get_post_type($post->ID);
  $fields = get_wp_emprendedores_custom_fields ($type); ?>
		<div>
...
function wp_emprendedores_save_custom_fields( $post_id ) { //Save changes
	global $wpdb;
